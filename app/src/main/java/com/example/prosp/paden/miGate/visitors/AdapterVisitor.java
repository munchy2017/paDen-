...
public class AdapterVisitor extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    List<DataVisitor> data = Collections.emptyList();
    DataVisitor current;
    int currentPos = 0;

    // create constructor to innitilize context and data sent from MainActivity
    public AdapterVisitor(Context context, List<DataVisitor> data) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.container_visitor, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        final DataVisitor current = data.get(position);
